...
function (_React$Component) {
  _inherits(LogOnChange, _React$Component);
  ...
  function LogOnChange() {
    ...
    _classCallCheck(this, LogOnChange);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LogOnChange)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(LogOnChange, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
      var props = this.props;

      if (!(0, _shallowequal["default"])(prevProps.value, props.value)) {
